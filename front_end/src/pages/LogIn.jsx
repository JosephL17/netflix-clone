    ...
    >
      <div className='w-full h-full lg:bg-opacity-50'>
        <nav className='px-12 py-5'>
          <img src='/src/assets/netflix.png' alt="Netflix" className='h-12' />
          <button className='absolute top-0 right-0 bg-red-600  text-white rounded-md m-8 hover:bg-red-700 transition p-2 font-semibold'>Sign in</button>
        </nav>
